...
public class GoogleCloudStorageContainerSupport extends ExternalResource {
    ...
    public GoogleCloudStorageBlobStoreInfo createBlobstoreInfo() {
        ...
        info.setHost(getEmulatorEndpoint());
    ...
    public GoogleCloudStorageBlobStore createBlobStore(String prefix, TileLayerDispatcher layers)
    ...
    public GoogleCloudStorageClient createClient(String prefix) {
        GeoWebCacheEnvironment env = new GeoWebCacheEnvironment();
        GoogleCloudStorageBlobStoreInfo info = createBlobstoreInfo(prefix);
        GoogleCloudStorageClient client = GoogleCloudStorageClient.buildClient(info, env);
        return client;
    }
}
