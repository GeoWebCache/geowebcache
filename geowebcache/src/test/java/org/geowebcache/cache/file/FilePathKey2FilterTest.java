...
public class FilePathKey2FilterTest extends TestCase {
    ...
    public void testFilter() throws Exception {
        ...
        // Check extensions
        fpk2f = new FilePathKey2Filter(SRS.getEPSG4326(), -1, -1, null, ImageMime.png);
        assertTrue(fpk2f.accept(dir, "123_456.png"));
        
        fpk2f = new FilePathKey2Filter(SRS.getEPSG4326(), -1, -1, null, ImageMime.jpeg);
        assertFalse(fpk2f.accept(dir, "123_456.png"));
        
        // Check zoomlevel
        fpk2f = new FilePathKey2Filter(SRS.getEPSG4326(), 0, 3, null, ImageMime.png);
        ...
        fpk2f = new FilePathKey2Filter(SRS.getEPSG4326(), 0, 2, bounds, ImageMime.png);
