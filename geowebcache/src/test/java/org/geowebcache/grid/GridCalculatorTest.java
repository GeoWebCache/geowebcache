...
public class GridCalculatorTest extends TestCase {
    ...
    public void test0linearSearch() throws Exception {
        ...
        GridSet gridSet = GridSetFactory.createGridSet("bogus", SRS.getSRS(0), bbox, false, resolutions, null, null, null, 256, 256);        
    ...
    public void testCustomSRSGridBottomLeft() throws Exception {
        ...
        GridSet gridSet = GridSetFactory.createGridSet("bogus", SRS.getSRS(26713), gridBase, false, 30, null, 256, 256);
    ...
    public void testTopLeftNaive() throws Exception {
        ...
        GridSet gridSet = GridSetFactory.createGridSet("bogus", SRS.getSRS(4326), gridBase, true, 30, null, 256, 256);
        GridSubset gridSubset = GridSubsetFactory.createGridSubSet(gridSet, bbox, 0, 20);
    ...
    public void testCustomSRSGridTopLeft() throws Exception {
        ...
        GridSet gridSet = GridSetFactory.createGridSet("bogus", SRS.getSRS(26713), gridBase, true, 30, null, 256, 256);
        GridSubset gridSubset = GridSubsetFactory.createGridSubSet(gridSet, bbox, 0, 20);
