...
public class GridSetFactoryTest extends TestCase {
    ...
    public void testResolutionsArrayEPSG4326() throws Exception {
        ...
        GridSet gridSet = GridSetFactory.createGridSet("test", SRS.getEPSG4326(), extent, resolutions, null, null, 256, 256);
    ...
    public void testResolutionsArrayEPSG3785() throws Exception {
        ...
        GridSet gridSet = GridSetFactory.createGridSet("test", SRS.getEPSG3857(), extent, resolutions, null, null, 256, 256);
    ...
    public void testResolutionsArrayTricky1() throws Exception {
        ...
        GridSet gridSet = GridSetFactory.createGridSet("test", SRS.getEPSG4326(), extent, resolutions, null, null, 200, 200);
