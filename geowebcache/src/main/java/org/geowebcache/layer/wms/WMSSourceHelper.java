...
/**
 * Builds WMS requests to gather a certain tile or meta tile. The actual communication with
 * the server is delegated to subclasses (might be a real HTTP request, but also an in process
 * one in the case of GeoServer)
 */
