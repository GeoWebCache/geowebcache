...
public class GridCalculator {
    ...
    public int[] gridLocation(BBOX tileBounds) {
        ...
        // X
        retVals[0] = (int) Math.round((tileBounds.coords[0] - base.coords[0])
                / tileWidth);
        // Y
        retVals[1] = (int) Math.round((tileBounds.coords[1] - base.coords[1])
                / tileWidth);
    ...
    /**
     * Calculates he bounding box for the meta tile based on the grid calculated
     * above.
     * 
