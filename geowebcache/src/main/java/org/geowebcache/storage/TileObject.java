...
/**
 * Represents a specific tile in a {@link GridSet}, identified by xyz. Normally the contnts can be 
 * either an image or a regionated KML tile, the class is format agnostic and just holds an array of bytes.
 */
