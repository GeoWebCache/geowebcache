...
/**
 * A raster filter allows to optimize data loading by avoiding the 
 * generation of requests and the caching of empty tiles for tiles 
 * that are inside the definition area of the layer but that are 
