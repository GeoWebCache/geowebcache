...
public interface QuotaStore {
     ...
     * values for the stored versions of the page statistics using {@link PageStats#addHits(long)};
     * these values are influenced by the {@code PageStats}' {@link PageStats#getFillFactor()
     * fillFactor}.
     *
     * @param statsUpdates
     * @return
