...
/**
 * An {@link NamedParameterJdbcTemplate} extended with some utility methods and with failure
 * reporting which includes the parameter values for parameterized statements
 *
 * @author Andrea Aime - GeoSolutions
 */
