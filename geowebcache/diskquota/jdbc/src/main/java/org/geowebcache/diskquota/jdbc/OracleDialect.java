...
/**
 * Oracle dialect for the quota store, compared to the basic one creates index organized tables and
 * uses the Oracle specific syntax to get the pages with the oldest access time and lowest access
 * frequency
 *
