...
public class SQLDialect {
    ...
    private boolean tableExists(SimpleJdbcTemplate template, final String schema, final String tableName) {
        try {
            ...
            return (Boolean) JdbcUtils.extractDatabaseMetaData(ds, dbmd -> {
    ...
    public String updatePageStats(
            ...
            String newHitsParam,
            String oldHitsParam,
            String newFrequencyParam,
            String oldFrequencyParam,
            String newLastAccessTimeParam,
            String oldLastAccessTimeParam) {
        StringBuilder sb = new StringBuilder("UPDATE ");
        if (schema != null) {
            sb.append(schema).append(".");
        }
