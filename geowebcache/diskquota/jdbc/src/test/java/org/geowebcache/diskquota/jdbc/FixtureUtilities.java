 ...
 *
 * <p>Static methods to support the implementation of tests that use fixture configuration files. See
...
public class FixtureUtilities {
    ...
    /**
     * Return the directory containing GeoTools test fixture configuration files. This is ".geowebcache" in the user
     * home directory.
     */
     ...
     *
     * <p>This method allows tests that cannot extend {@link OnlineTestCase} because they already extend another class
     * (for example, a non-online test framework) to access fixture configuration files in the same way that those
     * classes do. Only basic fixture configuration loading is supported. This method does not support the extra
