 ...
 *
 * <p>Static methods to support the implementation of tests that use fixture configuration files.
 * See {@link OnlineTestCase} and {@link OnlineTestRule} for details.
 *
...
public class FixtureUtilities {
     ...
     * ".geowebcache" in the user home directory.
     */
    public static File getFixtureDirectory() {
        return new File(System.getProperty("user.home") + File.separator + ".geowebcache");
    }
    ...
    public static File getFixtureFile(File fixtureDirectory, String fixtureId) {
        return new File(
                fixtureDirectory, fixtureId.replace('.', File.separatorChar).concat(".properties"));
    }
     ...
     *
     * <p>This method allows tests that cannot extend {@link OnlineTestCase} because they already
     * extend another class (for example, a non-online test framework) to access fixture
     * configuration files in the same way that those classes do. Only basic fixture configuration
     * loading is supported. This method does not support the extra services such as fixture caching
     * and connection testing provided by {@link OnlineTestCase}.
     *
