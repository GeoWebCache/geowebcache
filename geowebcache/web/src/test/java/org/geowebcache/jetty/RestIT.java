                ...
                doc -> {
                    assertThat(
                            ...
                            hasXPath(
                                    ...
                                    equalTo(
                                            jetty.getUri()
                                                    .resolve("/geowebcache/layers/img+states.xml")
                                                    .toString())));
                    assertThat(
                            doc,
                            hasXPath(
                                    ...
                                    equalTo(
                                            jetty.getUri()
                                                    .resolve(
                                                            "/geowebcache/layers/topp%3Astates.xml")
                                                    .toString())));
                    assertThat(
                            doc,
                            hasXPath(
                                    ...
                                    equalTo(
                                            jetty.getUri()
                                                    .resolve(
                                                            "/geowebcache/layers/raster+test+layer.xml")
                                                    .toString())));
        ...
        for (CloseableHttpClient client :
            ...
            doGetXML(
                    ...
                    doc -> {
                        assertThat(
                                doc,
                                not(hasXPath("//wmsUrl", containsString("demo.boundlessgeo.com"))));
