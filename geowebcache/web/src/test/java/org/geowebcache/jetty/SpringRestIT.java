...
public class SpringRestIT {
    ...
    public void testSeedFormPost() throws Exception {
        String seedQuery =
                "threadCount=04&type=truncate&gridSetId=EPSG:4326&tileFormat=image/png&zoomStart=01&zoomStop=12&minX=&minY=&maxX=&maxY=";
    ...
    public void testSeedFormPostUrlEncoded() throws Exception {
        String seedQueryUrlEncoded =
                "threadCount=04&type=truncate&gridSetId=EPSG%3A4326&tileFormat=image%2Fpng&zoomStart=01&zoomStop=12&minX=&minY=&maxX=&maxY=";
    ...
    public void testSeedFormPostSpaceDelimited() throws Exception {
        String seedQuerySpaceDelimited =
                "threadCount=04 type=truncate gridSetId=EPSG:4326 tileFormat=image/png zoomStart=01 zoomStop=12 minX= minY= maxX= maxY=";
    ...
    public void testSeedFormPostQuery() throws Exception {
        ...
        CloseableHttpResponse response =
                handlePost(
                        URI.create("/geowebcache/rest/seed/topp:states?" + seedQueryUrlEncoded),
                        admin.getClient(),
                        "");
        assertEquals(200, response.getStatusLine().getStatusCode());
    }
