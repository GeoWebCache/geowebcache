...
public class MetaTileTest extends TestCase {
    ...
    public void test1MetaTile() throws Exception {
        ...
        GridSubset grid =
                GridSubsetFactory.createGridSubSet(gridSetBroker.WORLD_EPSG4326, bbox, 0, 30);
    ...
    public void test3MetaTile() throws Exception {
        ...
        GridSubset grid =
                GridSubsetFactory.createGridSubSet(gridSetBroker.WORLD_EPSG3857, bbox, 0, 30);
    ...
    private void commonCreateTileFromMetaTileTest(Color[][] colors, RenderedImage metaTileImage)
        ...
        GridSubset grid =
                GridSubsetFactory.createGridSubSet(
                        gridSetBroker.WORLD_EPSG4326, boundingBox, 0, 21);
        long[] gridPos = {0, 0, 0};
        MetaTile metaTile =
