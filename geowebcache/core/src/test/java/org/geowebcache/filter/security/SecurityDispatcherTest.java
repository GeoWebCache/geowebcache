...
public class SecurityDispatcherTest {
    ...
    public void testOneFilterPass() throws Exception {
        ...
        EasyMock.expect(subset.boundsFromIndex(EasyMock.aryEq(new long[] {1,2,3}))).andStubReturn(bbox);
        EasyMock.expect(subset.getSRS()).andStubReturn(srs);
        
        filter.checkSecurity(layer,  bbox, srs); EasyMock.expectLastCall().once();
    ...
    public void testOneFilterFail() throws Exception {
        ...
        filter.checkSecurity(layer, bbox, srs); EasyMock.expectLastCall().andThrow(new SecurityException()).once();
    ...
    public void testTwoFilterPass() throws Exception {
        ...
        filter1.checkSecurity(layer,  bbox, srs); EasyMock.expectLastCall().once();
        filter2.checkSecurity(layer,  bbox, srs); EasyMock.expectLastCall().once();
    ...
    public void testTwoFilterFail() throws Exception {
        ...
        filter1.checkSecurity(layer,  bbox, srs); EasyMock.expectLastCall().andThrow(new SecurityException()).once();
        filter2.checkSecurity(layer,  bbox, srs); EasyMock.expectLastCall().times(0, 1);
