...
public class GridSubSetFactoryTest extends TestCase {
    ...
    public void testCoverageBounds() throws Exception {
        ...
        GridSubset grid =
                GridSubsetFactory.createGridSubSet(gridSetBroker.WORLD_EPSG4326, bbox, 0, 0);
    ...
    public void testCoverageBounds2() throws Exception {
        ...
        GridSubset grid =
                GridSubsetFactory.createGridSubSet(gridSetBroker.WORLD_EPSG4326, bbox, 0, 1);
    ...
    public void testGridNames() throws Exception {
        ...
        GridSubset grid =
                GridSubsetFactory.createGridSubSet(
                        gridSetBroker.WORLD_EPSG4326, bbox, zoomStart, zoomStop);
    ...
    public void testWMTSCoverage() throws Exception {
        ...
        GridSubset grid =
                GridSubsetFactory.createGridSubSet(gridSetBroker.WORLD_EPSG4326, bbox, 1, 3);
