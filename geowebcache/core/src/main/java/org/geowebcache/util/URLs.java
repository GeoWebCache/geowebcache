...
public class URLs {
     ...
     * in Java 21</a>.
     *
     * <p>Note a {@link URISyntaxException} will be rethrown as {@link MalformedURLException} to preserve the behavior
     * of code that used to call {@code new URL(String)} and expected either a {@code MalformedURLException} or its
     * super type {@code java.io.IOException}.
     *
     * @param url a URL string to build a {@link URL} from
     * @return the URL built from the argument
     * @throws MalformedURLException if {code}url{code} is not a valid {@link URI} nor a valid {@link URL} as per
     *     {@link URI#toURL()}
     */
