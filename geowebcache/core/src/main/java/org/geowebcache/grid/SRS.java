...
public class SRS implements Comparable<SRS> {
    ...
    public boolean equals(Object obj) {
        if (obj instanceof SRS) {
            SRS other = (SRS) obj;
            if (other.number == this.number || (this.number == 3857 && other.number == 900913)
    ...
    /**
     * Checks whether this SRS is equal to the given one, including whether the given one is a known
     * alias for this SRS or viceversa.
     * 
     * @param srs
     * @return
     */
    public boolean equalsIncludingAlias(SRS srs) {
        /* TODO we don't support alias yet but will eventually do */
        return equals(srs);
    }
}
