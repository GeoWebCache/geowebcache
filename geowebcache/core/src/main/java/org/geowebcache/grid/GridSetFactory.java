...
public class GridSetFactory {
     ...
     * resolutions or on scaleDenoms .Note that you should provide EITHER resolutions or
     * scales. Providing both will cause a precondition violation exception.
     * @param extent the bounding box for the gridset
     * @param resolutions the resolutions of each grid. Set to {@code null} if grids should be calculated
     *                    using scaleDenoms instead. Resolutions should be in metres per pixel
     * @param scaleDenoms the scale Denominators of each grid. Set to {@code null} if grids should be calculated
     *                    using resolutions instead
     * @param pixelSize the size of a pixel in meters. Used when calculating grids using scale denominators
     ...
     * @param alignTopLeft Indicates how the matrix should be aligned within the extent, where {@code true}
     *                     means that the matrix should be aligned with the top left of the extent and
     *                     {@code false} means that it should be aligned with the bottom left.
     * @param metersPerUnit the number of meters per unit in the scale denominator. e.g. if the scale is
     *                      1/28000, then this should be set to 1.0 and the relevant scaleDenom will be 28000
