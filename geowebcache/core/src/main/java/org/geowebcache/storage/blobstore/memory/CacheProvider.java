...
/**
 * Interface providing access to a cache object. It must be used by the {@link MemoryBlobStore}
 * class for caching {@link TileObject} instances. This cache should be configured only with the
 * setConfiguration method and should be modified by calling in sequence: resetCache() and
