...
/**
 * Represents a TileJSON v 3.0 object, see also https://github.com/mapbox/tilejson-spec/tree/3.0/3.0.0 (it's a draft of
 * a spec that has explicit support for layers and attributes)
 */
