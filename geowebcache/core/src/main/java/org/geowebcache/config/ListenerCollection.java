...
/**
 * Aggregates listeners and allows for their handlers to be called in
 * a consistent way. 
 * 
 * @author smithkm
 *
...
public class ListenerCollection<Listener> {
     ...
     * @param listener
     */
    synchronized public void add(Listener listener) {
     ...
     * @param listener
     */
    synchronized public void remove(Listener listener) {
     ...
     * @throws IOException
     */
    synchronized public void safeForEach(HandlerMethod<Listener> method) throws GeoWebCacheException, IOException {
