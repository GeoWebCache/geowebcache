...
public interface Configuration {
     ...
     *
     * <p>Any gridset provided by this configuration must be added to {@code gridSetBroker}
     *
     * <p>Any layer provided by this configuration must be {@link
     * TileLayer#initialize(GridSetBroker) initialized} with the provided {@code gridSetBroker}.
     *
     * @param gridSetBroker
    ...
    /**
     * Adds, but not saves, the given tile layer to this configuration, provided {@link
     * #canSave(TileLayer) canSave(tl) == true}.
     *
