...
public class WMTSController {
    ...
    @Autowired private DefaultStorageFinder defaultStorageFinder;

    @Autowired private RuntimeStats runtimeStats;

    @Autowired private SecurityDispatcher secDispatcher;
    ...
    public void getTile(
            ...
            @PathVariable Optional<String> style,
    ...
    private void manageCapabilitiesRequest(
    ...
    private void manageRequest(
        ...
        try {
            ...
            if (layer != null) values.put("layer", layer);
            if (type != null) values.put("request", type);
            if (style.isPresent()) values.put("style", style.get());
            if (tileMatrixSet != null) values.put("tilematrixset", tileMatrixSet);
            if (tileMatrix != null) values.put("tilematrix", tileMatrix);
            if (tileRow != null) values.put("tilerow", tileRow);
            if (tileCol != null) values.put("tilecol", tileCol);
            if (format != null) values.put("format", format);
            if (infoformat != null) values.put("infoformat", infoformat);
            if (j != null) values.put("j", j);
            if (i != null) values.put("i", i);
