...
public class SubStatsTest extends TestCase {
    ...
    public void testAddRecoverableIssue() throws Exception {
        ...
        assertThat("Expected the first issue to be present", subStats.getRecoverableIssues().findFirst().isPresent());
        assertThat("Expected the issue to be set", issue, is(subStats.getRecoverableIssues().findFirst().get()));
    }
    ...
    public void testAddNonRecoverableIssue() throws Exception {
        ...
        assertThat("Expected the first issue to be present", subStats.getNonRecoverableIssues().findFirst().isPresent());
        assertThat("Expected the issue to be set", issue, is(subStats.getNonRecoverableIssues().findFirst().get()));
    }
    ...
    public void testAddUnknownIssue() throws Exception {
        ...
        assertThat("Expected the first issue to be present", subStats.getUnknownIssues().findFirst().isPresent());
        assertThat("Expected the issue to be set", issue, is(subStats.getUnknownIssues().findFirst().get()));
    }
