...
public class DeleteTileParametersIdTest {
    ...
    public void testConstructor_DeleteTileParametersId_PrefixNull() {
        assertThrows(NullPointerException.class, () -> new DeleteTileParametersId(null, BUCKET, LAYER_ID, GRID_SET_ID, FORMAT_IN_KEY, PARAMETERS_ID, LAYER_NAME));
    }
    ...
    public void testConstructor_DeleteTileParametersId_BucketNull() {
        assertThrows("Bucket is missing", NullPointerException.class, () -> new DeleteTileParametersId(PREFIX, null, LAYER_ID, GRID_SET_ID, FORMAT_IN_KEY, PARAMETERS_ID, LAYER_NAME));
    }

    @Test
    public void testConstructor_DeleteTileParametersId_BucketEmpty() {
        assertThrows("Bucket is invalid", IllegalArgumentException.class, () -> new DeleteTileParametersId(PREFIX, " \t\n", LAYER_ID, GRID_SET_ID, FORMAT_IN_KEY, PARAMETERS_ID, LAYER_NAME));
    }
    ...
    public void testConstructor_DeleteTileParametersId_LayerIdNull() {
        assertThrows("LayerId is missing", NullPointerException.class, () -> new DeleteTileParametersId(PREFIX, BUCKET, null, GRID_SET_ID, FORMAT_IN_KEY, PARAMETERS_ID, LAYER_NAME));
    }

    @Test
    public void testConstructor_DeleteTileParametersId_LayerIdEmpty() {
        assertThrows("LayerId is invalid", IllegalArgumentException.class, () -> new DeleteTileParametersId(PREFIX, BUCKET, " \t\n", GRID_SET_ID, FORMAT_IN_KEY, PARAMETERS_ID, LAYER_NAME));
    }
    ...
    public void testConstructor_DeleteTileParametersId_GridSetIdNull() {
        assertThrows("GridSetId is missing", NullPointerException.class, () -> new DeleteTileParametersId(PREFIX, BUCKET, LAYER_ID, null, FORMAT_IN_KEY, PARAMETERS_ID, LAYER_NAME));
    }

    @Test
    public void testConstructor_DeleteTileParametersId_GridSetIdEmpty() {
        assertThrows("GridSetId is invalid", IllegalArgumentException.class, () -> new DeleteTileParametersId(PREFIX, BUCKET, LAYER_ID, " \t\n", FORMAT_IN_KEY, PARAMETERS_ID, LAYER_NAME));
    }
    ...
    public void testConstructor_DeleteTileParametersId_FormatNull() {
        assertThrows("Format is missing", NullPointerException.class, () -> new DeleteTileParametersId(PREFIX, BUCKET, LAYER_ID, GRID_SET_ID, null, PARAMETERS_ID, LAYER_NAME));
    }

    @Test
    public void testConstructor_DeleteTileParametersId_FormatEmpty() {
        assertThrows("Format is invalid", IllegalArgumentException.class, () -> new DeleteTileParametersId(PREFIX, BUCKET, LAYER_ID, GRID_SET_ID, " \t\n", PARAMETERS_ID, LAYER_NAME));
    }
    ...
    public void testConstructor_DeleteTileParametersId_ParametersIdMissing() {
        assertThrows("ParametersId is missing", NullPointerException.class, () -> new DeleteTileParametersId(PREFIX, BUCKET, LAYER_ID, GRID_SET_ID, FORMAT_IN_KEY, null, LAYER_NAME));
    }

    @Test
    public void testConstructor_DeleteTileParametersId_ParametersIdEmpty() {
        assertThrows("ParametersId is invalid", IllegalArgumentException.class, () -> new DeleteTileParametersId(PREFIX, BUCKET, LAYER_ID, GRID_SET_ID, FORMAT_IN_KEY, " \t\n", LAYER_NAME));
    }
    ...
    public void testConstructor_DeleteTileParametersId_LayerNameNull() {
        assertThrows("LayerName is missing", NullPointerException.class, () -> new DeleteTileParametersId(PREFIX, BUCKET, LAYER_ID, GRID_SET_ID, FORMAT_IN_KEY, PARAMETERS_ID, null));
    }
