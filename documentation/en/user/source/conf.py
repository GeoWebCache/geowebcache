...
# pixels large.
html_favicon = "../../theme/_static/geowebcache.ico"
...
htmlhelp_basename = 'GeoWebCacheUserManual'
...
latex_documents = [
  ('index', 'GeoWebCacheUserManual.tex', u'GeoWebCache User Manual',
   u'GeoWebCache', 'manual'),
]

# The name of an image file (relative to this directory) to place at the top of
# the title page.
latex_logo = '../../theme/_static/chrome/geowebcache-logo.png'
