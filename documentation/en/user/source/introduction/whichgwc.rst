...
This documentation discusses the standalone version of GeoWebCache.  For more information about GeoWebCache in GeoServer, see `<http://docs.geoserver.org/stable/en/user/geowebcache/index.html>`_.
